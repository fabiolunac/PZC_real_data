...
(
	...
	output signed    [NBITS_OUT_DESLOC -1:0] io_out_13b
);
...
begin
	...
	begin
		//Accumulator
		out_delay <= (in-pedestal)*144 + out_delay - m_out - ped_reg_out_corr;
...
//PZC output
assign io_out = (in - pedestal)*144 + out_delay + M_FACTOR * 144 * (in - pedestal);

assign io_out_13b = io_out >>> 16;
